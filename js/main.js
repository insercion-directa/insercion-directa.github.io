   var textColor = "#34495e";  // I would use 'const', not 'var', but it breaks in IE
   var borderColor = "#18bc9c"; 
   var barColor = "#c0392b";
   var finishedBarColor = "#c0392b";
   var movingBarColor = "#16a085";
   var movingBarOutlineColor = "#888";
   var boxColor = "#c0392b";
   var multiBoxColor = "#16a085";
   var maxColor = "#F00";
